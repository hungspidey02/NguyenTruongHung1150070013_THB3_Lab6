...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btnGoLength, btnGoCustom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnGoCustom = findViewById(R.id.btnGoCustom);
        btnGoCustom.setOnClickListener(v ->
        ...
        btnGoCustom = findViewById(R.id.btnGoCustom);
